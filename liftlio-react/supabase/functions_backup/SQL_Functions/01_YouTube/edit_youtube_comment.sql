-- =============================================
-- Função: edit_youtube_comment
-- Descrição: Edita um comentário existente no YouTube
-- Criado: 2025-01-23
-- =============================================
...
CREATE OR REPLACE FUNCTION public.edit_youtube_comment(
    project_id integer,
    comment_id text,
...
-- Versão sem project_id (usa projeto padrão 1)
