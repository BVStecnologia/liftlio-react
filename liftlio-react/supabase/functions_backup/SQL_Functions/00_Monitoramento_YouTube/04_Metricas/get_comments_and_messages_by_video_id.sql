...
-- Descrição: Obtém comentários e mensagens de um vídeo específico
-- Criado: 2025-01-23
-- Atualizado: 2025-01-23
-- =============================================

DROP FUNCTION IF EXISTS get_comments_and_messages_by_video_id(BIGINT);

CREATE OR REPLACE FUNCTION get_comments_and_messages_by_video_id(video_id_param bigint)
RETURNS TABLE(
    ...
    lead_score text,
    project_id bigint,
    justificativa_comentario character varying,
    id_mensagem bigint,
    mensagem text,
    respondido boolean,
    comentario_principal_id bigint,
    justificativa_mensagem character varying,
