// @ts-nocheck
/**
 * Edge Function: agente-liftlio (v9 - Dados reais apenas)
 * 
 * Descrição:
 * Versão corrigida que NUNCA inventa dados - usa apenas métricas reais.
 * 
 * Melhorias v9:
 * - Regras rígidas contra invenção de dados
 * - Validação de dados antes de responder
 * - System prompt reforçado para usar apenas projectStats
 * - Logs detalhados de dados usados na resposta
 * 
