-- =============================================
-- Migration: Fix process_lead_comments_with_claude function
-- Data: 2025-10-17
-- Problema: Função retornava NULL devido a resposta do Claude não estar em JSON puro
-- Solução: Adicionar extração de JSON da resposta do Claude
-- =============================================

CREATE OR REPLACE FUNCTION public.process_lead_comments_with_claude(
...
Text: %s',
    ...
    -- CORREÇÃO: Extrair JSON da resposta (caso venha com texto adicional)
...
'Processa comentários de leads usando Claude AI para gerar respostas contextualizadas.
CORREÇÃO (2025-10-17): Adicionada extração robusta de JSON da resposta do Claude para evitar falhas de parsing.';
