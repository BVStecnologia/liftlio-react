-- =============================================
-- Função: schedule_process_project (VERSÃO ROBUSTA)
-- Descrição: Agenda processamento de projetos com proteções contra loops
-- Criado: 2025-01-19T02:00:00.000Z
-- Versão: 2.0 - Com proteções contra loop infinito
-- =============================================

-- SEMPRE começar com DROP para limpar versão antiga
DROP FUNCTION IF EXISTS schedule_process_project() CASCADE;

CREATE OR REPLACE FUNCTION schedule_process_project()
RETURNS TRIGGER
SECURITY DEFINER
...
-- =============================================
-- IMPORTANTE: Funções chamadas NÃO devem criar novos jobs!
-- =============================================

COMMENT ON FUNCTION schedule_process_project() IS
'Versão 2.0 com proteções: Circuit breaker, validação de status, backoff dinâmico,
comando auto-validante. Jobs são temporários e controlados pelo trigger.';
