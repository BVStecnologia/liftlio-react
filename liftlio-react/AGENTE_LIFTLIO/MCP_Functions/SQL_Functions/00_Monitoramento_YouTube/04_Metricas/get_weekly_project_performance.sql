...
-- Descrição: Obtém performance semanal de um projeto
-- Criado: 2025-01-23
-- Atualizado: 2025-01-23
-- =============================================

DROP FUNCTION IF EXISTS get_weekly_project_performance(INTEGER, INTEGER);

CREATE OR REPLACE FUNCTION get_weekly_project_performance(
