...
-- Descrição: Obtém vídeos de um canal específico com métricas
-- Criado: 2025-01-23
-- Atualizado: 2025-01-23
-- =============================================

DROP FUNCTION IF EXISTS get_videos_by_channel_id(BIGINT);

CREATE OR REPLACE FUNCTION get_videos_by_channel_id(canal_id bigint)
RETURNS TABLE(
    id bigint,
    nome_do_video text,
    descricao text,
