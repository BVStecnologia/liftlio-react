...
-- Descrição: Processa vídeos monitorados para análise e comentários
-- Criado: 2025-01-23
-- =============================================

DROP FUNCTION IF EXISTS public.process_monitored_videos();

CREATE OR REPLACE FUNCTION public.process_monitored_videos()
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
