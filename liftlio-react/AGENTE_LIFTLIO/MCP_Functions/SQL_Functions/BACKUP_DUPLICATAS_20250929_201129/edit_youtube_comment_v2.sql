-- =============================================
-- Função: edit_youtube_comment (versão 2 - sem project_id)
-- Descrição: Edita comentário do YouTube usando projeto padrão
-- Criado: 2025-01-23
-- =============================================

DROP FUNCTION IF EXISTS public.edit_youtube_comment(text, text);

CREATE OR REPLACE FUNCTION public.edit_youtube_comment(comment_id text, new_comment_text text)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
