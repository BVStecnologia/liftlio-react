-- =============================================
-- Função: channel_performance_analysis
-- Descrição: Análise completa de performance de canais YouTube
-- Criado: 2025-01-24
-- =============================================

CREATE OR REPLACE FUNCTION public.channel_performance_analysis(p_project_id bigint, p_days_back integer DEFAULT 30)
 RETURNS TABLE(channel_id text, channel_name text, subscriber_count integer, total_videos bigint, monitored_videos bigint, total_comments bigint, total_posts bigint, posts_responded bigint, response_rate numeric, avg_response_time_hours numeric, posts_last_7_days bigint, posts_last_30_days bigint, avg_lead_score numeric, total_engagement_posts bigint, total_lead_posts bigint, best_performing_video jsonb, posting_schedule jsonb, performance_score numeric)
 LANGUAGE plpgsql
AS $function$
BEGIN
    RETURN QUERY
