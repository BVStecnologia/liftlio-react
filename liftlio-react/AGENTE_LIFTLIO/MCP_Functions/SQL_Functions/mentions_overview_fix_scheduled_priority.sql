-- View corrigida em 22/07/2025 para priorizar postagens agendadas
-- Problema: DISTINCT ON pegava qualquer registro, ignorando postagens pendentes
-- Solução: Ordenar por status para priorizar postagens pendentes
