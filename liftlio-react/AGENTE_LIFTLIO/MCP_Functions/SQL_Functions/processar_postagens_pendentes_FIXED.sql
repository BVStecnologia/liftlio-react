-- =============================================
-- Função: processar_postagens_pendentes (CORRIGIDA)
-- Data: 2025-01-29
-- Correção: Adiciona UPDATE para marcar mensagem como respondida
-- Bug corrigido: Mensagens ficavam com respondido=false mesmo após postadas
-- =============================================
...
'Processa postagens pendentes do YouTube.
CORREÇÃO 29/01/2025: Adiciona UPDATE para marcar mensagem como respondida após postagem bem-sucedida.
Corrige bug onde mensagens ficavam com respondido=false mesmo após serem postadas.';