-- Função corrigida em 21/01/2025
-- Corrige contagem de scheduled_mentions para considerar proxima_postagem > NOW()
-- Mantém total_mentions como contagem total (não apenas postadas)
