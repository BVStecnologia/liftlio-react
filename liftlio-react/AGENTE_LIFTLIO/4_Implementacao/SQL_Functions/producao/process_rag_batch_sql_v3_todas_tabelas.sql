-- Function: process_rag_batch_sql (v3 - Processa TODAS as tabelas)
-- Descrição: Versão corrigida que processa todas as tabelas com registros pendentes
...
BEGIN
    ...
    -- 2. Processar Comentários Principais
    ...
    -- 4. Processar Respostas_Comentarios
    IF v_remaining_quota > 0 THEN
        FOR v_record IN 
